...
<div class="container">
 <div class="col-md-6  offset-3 mb-3" id="result">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header font-weight-bold">{{ __('Edit Profile Information') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('profile.update',['user'=>$user->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description"   autocomplete="description" autofocus rows="5">{{$user->profile->description }}</textarea>
                        ...
                        <div class="form-group row">
                            <label for="url" class="col-md-4 col-form-label text-md-right">{{ __('Your Url') }}</label>
